...
import { CreditDisplay, CreditSummary } from '../leave/components/credit-display';
...
export default function AbsenceCredit({ employees = [], monthlyAbsenceStats = [], user_permissions }: Props) {
    ...
    return (
        <SidebarProvider>
            <Head title="Absence Credit Summary" />
            <SidebarHoverLogic>
                <SidebarInset>
                    ...
                    <Main fixed>
                        <div className="mb-6 flex flex-wrap items-center justify-between space-y-2 gap-x-4">
                            <div>
                                <div className="ms-2 flex items-center">
                                    ...
                                    <div className="ms-2">
                                        <h2 className="flex text-2xl font-bold tracking-tight">Absence Credit Summary</h2>
                                        <p className="text-muted-foreground">Monitor employee absence credits and usage</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* {employees.length > 0 && (
                            <div className="mb-6">
                                <Card>
                                    <CardHeader>
                                        <CardTitle className="text-lg font-semibold">Employee Absence Credits Overview</CardTitle>
                                        <CardDescription>Summary of absence credits across all employees</CardDescription>
                                    </CardHeader>
                                    <CardContent>
                                        <CreditSummary employees={employees} creditType="absence" />
                                    </CardContent>
                                </Card>
                            </div>
                        )} */}
                        ...
                        {paginatedEmployees.length > 0 ? (
                            <div className="mb-6">
                                <Card>
                                    <CardHeader>
                                        <CardTitle className="text-lg font-semibold">Employee Absence Credits</CardTitle>
                                        <CardDescription>
                                    ...
                                    <CardContent>
                                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                                            {paginatedEmployees.map((employee) => (
                                                <CreditDisplay key={employee.id} employee={employee} creditType="absence" />
                                            ))}
                                        </div>
                                    </CardContent>
                                </Card>
