...
export function SectionCards({ employee, totalDepartment, totalEmployee, isSupervisor = false, roleContent }: Props) {
    ...
    return (
        <div className="grid grid-cols-1 gap-4 overflow-hidden px-4 *:data-[slot=card]:shadow-xs lg:px-3 @xl/main:grid-cols-2 @2xl/main:grid-cols-4 dark:*:data-[slot=card]:bg-card">
            ...
            <Card className="@container/card border-l-4 border-blue-500 bg-gradient-to-br from-blue-500 to-white shadow-lg transition-all duration-300 hover:shadow-xl overflow-hidden">
                <CardHeader className="relative">
                    <div className="flex items-center justify-between">
