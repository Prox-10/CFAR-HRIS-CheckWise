...
import { AlertCircle, CalendarIcon, CheckCircle, DollarSign, PhilippinePeso, RefreshCw } from 'lucide-react';
...
export default function PayAdvancement({ employees = [], errors, success }: Props) {
  ...
  const handleEmployeeSelect = (employeeId: string) => {
    ...
    if (employee) {
      ...
      console.error('Available employees:', employees.map(emp => ({ id: emp.id, name: emp.employee_name })));
    }
  };
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.post('/service-tenure/pay-advancement/store', {
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground">
                          💡 You can search by Employee ID or Employee Name
                        </p>
                      </div>
                        ...
                        <div className="space-y-4 rounded-lg border border-green-200 bg-green-50 p-4">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-sm font-semibold text-green-600">{selectedEmployee.remaining_years} years</p>
                            </div>
                          </div>
                        </div>
                      )}
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                              <Input
                                ...
                                onChange={(e) => setFormData(prev => ({ ...prev, equivalent_amount: e.target.value }))}
                              />
                              <Button
                                type="button"
                                variant="outline"
              ...
              <div className="lg:col-span-1">
                <Card className="border-main bg-background drop-shadow-lg dark:bg-backgrounds">
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      <h4 className="font-semibold text-gray-800 mb-2">Eligibility Rules:</h4>
