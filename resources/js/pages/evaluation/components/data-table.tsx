...
export function DataTable<TData, TValue>({ columns, data, employees, employees_all }: DataTableProps<TData, TValue>) {
    ...
    const columnsWithHandlers = React.useMemo(() =>
        typeof columns === 'function'
            ? columns(setIsModelOpen, setViewModalOpen, setEditModalOpen, setSelectedEvaluation)
            : columns,
        [columns]
    );
